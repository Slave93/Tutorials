...
import templateapp.core.dao.MessageDAO;
import templateapp.core.dao.MessageDAOImpl;
import templateapp.core.model.Message;
import templateapp.rest.exception.DataNotFoundException;
...
public class MessageResource {
	...
	public Response addMessage(Message message,@Context UriInfo uriInfo,@QueryParam("profileName") String profileName) {
		if(profileName==null){
			...
			ErrorMessage errorMessage = new ErrorMessage("Must provide profile name in query param");
